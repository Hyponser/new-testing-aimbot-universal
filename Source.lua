...
༺☆༻____________☾✧ ✩ ✧☽____________༺☆༻༺☆༻____________☾✧ ✩ ✧☽____________༺☆༻
    ...
    License: MIT
    GitHub: https://discord.gg/karvscripts
...
pcall(function()
    if not DEBUG and getfenv().isfile and getfenv().readfile and getfenv().isfile(string.format("%s.harassment", game.GameId)) and getfenv().readfile(string.format("%s.harassment", game.GameId)) and UISettings.AutoImport then
        ImportedConfiguration = HttpService:JSONDecode(getfenv().readfile(string.format("%s.harassment", game.GameId)))
...
do
    ...
    AimbotSection:AddButton({
        ...
        Callback = function()
            ...
            AimPartDropdown:SetValues(Configuration.AimPartDropdownValues)
            Window:Dialog({
                Title = string.format(MonthlyLabels[os.date("*t").month], "Karvied.cc"),
    ...
    if getfenv().isfile and getfenv().readfile and getfenv().writefile and getfenv().delfile then
        ...
        ConfigurationManager:AddButton({
            ...
            Callback = function()
                xpcall(function()
                    if getfenv().isfile(string.format("%s.harassment", game.GameId)) and getfenv().readfile(string.format("%s.harassment", game.GameId)) then
                        local ImportedConfiguration = HttpService:JSONDecode(getfenv().readfile(string.format("%s.harassment", game.GameId)))
                        for Key, Value in next, ImportedConfiguration do
                        ...
                        Window:Dialog({
                            ...
                            Content = string.format("Configuration File %s.harassment has been successfully loaded!", game.GameId),
                            Buttons = {
                                {
                                    Title = "Confirm"
                                }
                        ...
                        Window:Dialog({
                            Title = "Configuration Manager",
                            Content = string.format("Configuration File %s.harassment could not be found!", game.GameId),
                            Buttons = {
                                {
                                    Title = "Confirm"
                                }
                    ...
                    Window:Dialog({
                        Title = "Configuration Manager",
                        Content = string.format("An Error occurred when loading the Configuration File %s.harassment", game.GameId),
                        Buttons = {
                            {
                                Title = "Confirm"
                            }
        ...
        ConfigurationManager:AddButton({
            ...
            Callback = function()
                xpcall(function()
                    ...
                    getfenv().writefile(string.format("%s.harassment", game.GameId), ExportedConfiguration)
                    Window:Dialog({
                        Title = "Configuration Manager",
                        Content = string.format("Configuration File %s.harassment has been successfully overwritten!", game.GameId),
                        Buttons = {
                            {
                                Title = "Confirm"
                            }
                    ...
                    Window:Dialog({
                        Title = "Configuration Manager",
                        Content = string.format("An Error occurred when overwriting the Configuration File %s.harassment", game.GameId),
                        Buttons = {
                            {
                                Title = "Confirm"
                            }
        ...
        ConfigurationManager:AddButton({
            ...
            Callback = function()
                if getfenv().isfile(string.format("%s.harassment", game.GameId)) then
                    getfenv().delfile(string.format("%s.harassment", game.GameId))
                    Window:Dialog({
                        Title = "Configuration Manager",
                        Content = string.format("Configuration File %s.harassment has been successfully removed!", game.GameId),
                        Buttons = {
                            {
                                Title = "Confirm"
                            }
    ...
    if getfenv().setclipboard then
        DiscordWikiSection:AddButton({
            ...
            Callback = function()
                getfenv().setclipboard("https://discord.gg/karvscripts")
                Window:Dialog({
                    Title = string.format(MonthlyLabels[os.date("*t").month], "Karvied.cc"),
...
local OnTeleport; OnTeleport = Player.OnTeleport:Connect(function()
    if DEBUG or not Fluent or not getfenv().queue_on_teleport then
        ...
        getfenv().queue_on_teleport("getfenv().loadstring(game:HttpGet(\"https://raw.githubusercontent.com/Hyponser/new-testing-aimbot-universal/refs/heads/main/Protected_8806239155286869.lua\", true))()")
        OnTeleport:Disconnect()
    end
end)
